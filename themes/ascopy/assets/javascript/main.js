...
$(function () {
  // Vacancy Toggle
  $('.js--toggle-vacancy').on('click', function () {
    $(this).closest('.vacancy-b__item').toggleClass('vacancy-b__item_active');
    $(this).closest('.vacancy-b__item').find('.vacancy-b__item-toggle').stop(true, true).slideToggle('fast');
    return false;
  }); // Comments Add Toggle
  ...
  $('.js--toggle-catalog').on('mouseenter', function () {
    $('.header-b__catalog').stop(true, true).fadeIn('fast');
    $(this).addClass('active');
    return false;
  });
  $('.header-b__catalog').on('mouseleave', function () {
    $('.header-b__catalog').stop(true, true).fadeOut('fast');
    $('.js--toggle-catalog').removeClass('active');
    return false;
  });
  $('.header-b__catalog-links').on('mouseenter', function () {
    $('.header-b__catalog-links').removeClass('header-b__catalog-links_active');
    $(this).addClass('header-b__catalog-links_active');
    var count = $(this).index();
    $('.header-b__catalog-list').removeClass('header-b__catalog-list_show');
    $('.header-b__catalog-list').eq(count).addClass('header-b__catalog-list_show');
    return false;
  });
  scrollHeader();
});
...
function scrollHeader() {
  ...
  if (sT > 146) {
    $('.header-mobile-b').addClass('header-mobile-b_show');
    $('.header-b__catalog').addClass('header-b__catalog_fixed');
  } else {
    $('.header-mobile-b').removeClass('header-mobile-b_show');
    $('.header-b__catalog').removeClass('header-b__catalog_fixed');
  }
}
