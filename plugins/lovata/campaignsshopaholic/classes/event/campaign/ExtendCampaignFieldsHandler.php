...
use Lovata\CampaignsShopaholic\Controllers\Campaigns;

/**
 * Class ExtendCampaignFieldsHandler
 * @package Lovata\CampaignsShopaholic\Classes\Event\Campaign
 * @author  Andrey Kharanenka, a.khoronenko@lovata.com, LOVATA Group
 */
class ExtendCampaignFieldsHandler extends AbstractBackendFieldHandler
{
    /**
     * Extend form fields
    ...
    protected function getFieldList($arPositionMechanismList, $arShippingTypeMechanismList)
    {
        $arFieldList = [
            'product'       => [
                ...
                'type'    => 'partial',
                'path'    => '~/plugins/lovata/campaignsshopaholic/controllers/campaigns/_product.htm',
            ...
            'offer'         => [
                ...
                'context' => ['update', 'preview'],
                'type'    => 'partial',
                'path'    => '~/plugins/lovata/campaignsshopaholic/controllers/campaigns/_offer.htm',
            ...
            'brand'         => [
                ...
                'context' => ['update', 'preview'],
                'type'    => 'partial',
                'path'    => '~/plugins/lovata/campaignsshopaholic/controllers/campaigns/_brand.htm',
            ...
            'category'      => [
                ...
                'context' => ['update', 'preview'],
                'type'    => 'partial',
                'path'    => '~/plugins/lovata/campaignsshopaholic/controllers/campaigns/_category.htm',
            ...
            'shipping_type' => [
                ...
                'context' => ['update', 'preview'],
                'type'    => 'partial',
                'path'    => '~/plugins/lovata/campaignsshopaholic/controllers/campaigns/_shipping_type.htm',
        ...
        if (PluginManager::instance()->hasPlugin('Lovata.TagsShopaholic')) {
            $arFieldList['tag'] = [
                ...
                'context' => ['update', 'preview'],
                'type'    => 'partial',
                'path'    => '~/plugins/lovata/campaignsshopaholic/controllers/campaigns/_tag.htm',
