...
class Subscriptions extends Controller
{
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Wapp.UserConnect', 'userconnect', 'subscriptions');
    }
    ...
    public function index_onDelete()
    {
        if (($checkedIds = post('checked')) && is_array($checkedIds) && count($checkedIds)) {
            ...
            Flash::success(Lang::get('wapp.userconnect::lang.subscriptions.delete_selected_success'));
        } else {
            Flash::error(Lang::get('wapp.userconnect::lang.subscriptions.delete_selected_empty'));
        }
